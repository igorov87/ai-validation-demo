      ...
      >
        <div class="flex justify-between items-start mb-4">
          ...
          <div class="flex gap-2">
            ...
            <button
              @click="$emit('enviarCorreo', requerimiento)"
              class="text-green-500 hover:text-green-700 transition duration-200"
              title="Enviar por correo"
              :disabled="enviandoCorreo[requerimiento.id]"
            >
              <svg v-if="!enviandoCorreo[requerimiento.id]" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
