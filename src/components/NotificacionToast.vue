  ...
  <div class="fixed bottom-4 right-4 z-50 space-y-2 max-w-md">
    <transition-group name="toast" tag="div">
      <div
        ...
        :key="notificacion.id"
        :class="getClaseNotificacion(notificacion.tipo)"
        class="flex items-start gap-3 p-4 rounded-lg shadow-lg backdrop-blur-sm transition-all duration-300"
      >
        <!-- Icono -->
        ...
        <!-- Botón cerrar -->
        <button
          @click="$emit('cerrar', notificacion.id)"
